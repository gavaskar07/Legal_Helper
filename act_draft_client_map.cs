...
namespace LH
{
    public partial class act_draft_client_map : Form
    {
        utilities util = new utilities();
        String status_1 = utilities.status;

        public act_draft_client_map()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    String insert = util.iud("INSERT INTO all_table (pid,f1, f2,f3,f4,status) values ('0','" + f1.Text + "','" + f2.Text + "','" + f3.Text + "','" + f4.Text + "','" + statusValue + "')");
                    if (insert == "sucess")
                    {
                ...
                {
                    String insert = util.iud("UPDATE all_table SET f1='" + f1.Text + "', f2='" + f2.Text + "', f3='" + f3.Text + "', f4='" + f4.Text + "' WHERE id=" + lb1_id.Text + "");
                    if (insert == "sucess")
                    {
        ...
        private void grd_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (grd.SelectedRows.Count > 0)
            {
                ...
                f4.Text = grd.SelectedRows[0].Cells[5].Value.ToString();       // File_path

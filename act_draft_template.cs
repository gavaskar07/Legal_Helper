...
namespace LH
{
    public partial class act_draft_template : Form
    {
        utilities util = new utilities();
        String status_1 = utilities.status;

        public act_draft_template()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    String insert = util.iud("INSERT INTO all_table (pid,f1, f2, f3, f4, f5, status ) values ('0','" + f1.Text + "','" + f2.Text + "','" + f3.Text + "','" + f4.Text + "','" + f5.Text + "','" + status.Text + "')");
                    if (insert == "sucess")
                    {
                ...
                {
                    String insert = util.iud("update all_table set f1='" + f1.Text + "', f2='" + f2.Text + "', f3='" + f3.Text + "', f4='" + f4.Text + "', f5='" + f5.Text + "' where id=" + lb1_id.Text + "");
                    if (insert == "sucess")
                    {
        ...
        private void load_grid()
        {
            ...
            {
                sno = sno + 1;
                grd.Rows.Add(drow["id"], sno, drow["f1"], drow["f2"], drow["f3"], drow["f4"], drow["f5"]);
            }
        }
        ...
        private void grd_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            f5.Text = grd.SelectedRows[0].Cells[6].Value.ToString();
